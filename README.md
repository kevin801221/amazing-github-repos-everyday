...
[![Daily Update](https://img.shields.io/badge/更新頻率-每日-brightgreen?style=for-the-badge)](./ai-repos-2026-07-21.md)
[![Focus](https://img.shields.io/badge/聚焦-AI%20%2F%20LLM%20%2F%20Agent-blue?style=for-the-badge)](https://github.com/topics/ai)
[![Latest](https://img.shields.io/badge/最新報告-2026--07--21-orange?style=for-the-badge)](./ai-repos-2026-07-21.md)

**跨日去重整理：同一個 GitHub repo 只在主索引保留一次，完整日報仍保留原始排序。**

[🔥 近三日必看](#-近三日必看) · [⭐ 推薦研究](#-推薦研究) · [📌 去重總索引](#-去重總索引) · [📅 歷史報告](#-歷史報告) · [🧭 趨勢雷達](#-趨勢雷達)
...
> 不想翻完整榜單？先從你最有感的題目點進去。

| 日期 | 最值得點開的主題 | 一句話亮點 | 完整文章 |
|:---:|:---|:---|:---:|
| **07-21** | **Agent 上網、AI 求職、反 AI 味設計** | hallmark 一週增加 9,173 星；Agent-Reach、orca 也在重新定義 Agent 的工具邊界。 | [看趨勢特刊 →](./ai-repos-2026-07-21.md) |
| **07-20** | **AI 不只聊天，開始真正幫人工作** | 從影片理解、研究、警報管理到手機 Agent，10 個項目都能對應具體工作。 | [看開源黑馬 →](./ai-repos-2026-07-20.md) |
| **07-19** | **影片理解、AI SRE、投資研究** | 適合想快速找到可直接試用、也容易展示成果的 AI 工具。 | [看 Agent 專案 →](./ai-repos-2026-07-19.md) |
...
> 更新至：**2026-07-21** · 已整合 **16 份報告** · 共 **42 個不重複 repo**<br>
...
| 2026-07-21 | 2026-07-21 | [ogulcancelik/herdr](https://github.com/ogulcancelik/herdr) | 18,786 | 在終端機同時管理、切換與監控多個 AI coding agents。 |
| 2026-07-21 | 2026-07-21 | [tirth8205/code-review-graph](https://github.com/tirth8205/code-review-graph) | 23,307 | 為 codebase 建立持久地圖，讓 AI coding 工具只讀真正相關的內容。 |
...
| 2026-07-18 | 2026-07-20 | [HUANGCHIHHUNGLeo/claude-real-video](https://github.com/HUANGCHIHHUNGLeo/claude-real-video) | 1,750 | 讓 Claude 或其他 LLM 以場景感知、去重影格與逐字稿理解影片的本地工具。 |
| 2026-07-18 | 2026-07-20 | [deer-flow/llm-space](https://github.com/deer-flow/llm-space) | 1,092 | 桌面 agent 原型工具，可檢視 harness 步驟、重播失敗案例並評估效能。 |
| 2026-07-17 | 2026-07-19 | [William-Lu-stack/Flawless](https://github.com/William-Lu-stack/Flawless) | 740 | 面向 Kubernetes 與雲端基礎設施的 AI SRE（AgenticOps）自動化工具。 |
| 2026-07-15 | 2026-07-20 | [AlephAITech/WorkBuddyGuide](https://github.com/AlephAITech/WorkBuddyGuide) | 1,119 | WorkBuddy 的開源實戰指南，彙整工作流、Skills、MCP、自動化與多代理範例。 |
| 2026-07-15 | 2026-07-20 | [Sahir619/fable-method](https://github.com/Sahir619/fable-method) | 1,728 | 將 Claude Fable 5 工作方法整理成可供不同模型使用的 think／act 技能集與評測。 |
| 2026-07-14 | 2026-07-20 | [SmileLikeYe/agent-chief](https://github.com/SmileLikeYe/agent-chief) | 908 | local-first 的注意力守門層，將 agent、警報與資訊流整合成單一可信介面。 |
| 2026-07-11 | 2026-07-11 | [modiqo/cliare](https://github.com/modiqo/cliare) | 712 | CLI「代理就緒度」量測工具，評估命令列工具對 AI agent 的友善程度。 |
| 2026-07-10 | 2026-07-20 | [uzairansaruzi/hermex](https://github.com/uzairansaruzi/hermex) | 868 | Hermes agent 的原生 iPhone App，讓個人 AI 代理可在行動裝置使用。 |
| 2026-07-10 | 2026-07-20 | [simonlin1212/Vibe-Research](https://github.com/simonlin1212/Vibe-Research) | 908 | 個人投資研究 Agent，涵蓋 A 股／美股／港股的復盤、資訊雷達與持倉研究。 |
...
| 2026-07-09 | 2026-07-21 | [JCodesMore/ai-website-cloner-template](https://github.com/JCodesMore/ai-website-cloner-template) | 29,126 | 搭配 AI 編碼代理快速複製網站，產出可用的專案骨架。 |
| 2026-07-09 | 2026-07-21 | [DeusData/codebase-memory-mcp](https://github.com/DeusData/codebase-memory-mcp) | 33,273 | 高效能程式碼理解 MCP，將 codebase 建成持久化知識圖譜。 |
...
| 2026-07-08 | 2026-07-20 | [synthetic-sciences/openscience](https://github.com/synthetic-sciences/openscience) | 2,604 | 面向科學研究的 AI workbench，加速實驗設計、資料分析與研究流程。 |
...
| 2026-07-06 | 2026-07-20 | [elder-plinius/T3MP3ST](https://github.com/elder-plinius/T3MP3ST) | 5,006 | 多代理紅隊演練平台，用於自動化滲透與攻擊性資安測試。 |
| 2026-07-06 | 2026-07-06 | [alchaincyf/fanbox](https://github.com/alchaincyf/fanbox) | 887 | 「vibe coding」駕駛艙，集中檔案、終端機與每次改動檢視。 |
| 2026-07-05 | 2026-07-20 | [jmerelnyc/Talos](https://github.com/jmerelnyc/Talos) | 991 | Talos 網路 GPU 工作節點客戶端，承接推論任務並回報運行時間。 |
...
| 2026-07-20 | 10 | 0 | [開源黑馬 →](./ai-repos-2026-07-20.md) |
| 2026-07-19 | 14 | 3 | [Agent 專案 →](./ai-repos-2026-07-19.md) |
...
| **多 Agent 開發環境** | orca、herdr 等工具把多個 coding agents 當成可並行調度、監控與切換的團隊。 |
| **反 AI 味與成果導向工具** | hallmark、AI 求職與影片理解專案都以一句話可懂的成果切中使用者痛點。 |
...
- 2026-07-03、2026-07-05、2026-07-06、2026-07-08、2026-07-10、2026-07-11、2026-07-13 至 2026-07-20 報告主要鎖定近 30 天內建立的 AI / LLM / Agent 專案。
